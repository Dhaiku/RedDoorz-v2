...
$hotels = $conn->query("SELECT h.*, COUNT(r.Room_Id) AS RoomCount FROM Hotels h LEFT JOIN Rooms r ON r.Room_HotelId=h.Hotel_Id GROUP BY h.Hotel_Id ORDER BY h.Hotel_CreatedAt DESC");
