...
if (isset($_POST['register'])) {
    ...
    if (empty($fname) || empty($lname) || empty($email) || empty($password)) {
        ...
        $check = $conn->query("SELECT Acct_Id FROM Accounts WHERE Acct_Email='$email' LIMIT 1");
        if ($check->num_rows > 0) {
            ...
            $conn->query("INSERT INTO Accounts (Acct_Email, Acct_Password, Acct_Role) VALUES ('$email', '$hashed', 'customer')");
            $acctId = $conn->insert_id;
            $conn->query("INSERT INTO Customers (Cust_AcctId, Cust_FName, Cust_LName, Cust_Phone) VALUES ('$acctId', '$fname', '$lname', '$phone')");
        ...
        <div class="img-overlay">
            <div style="color:#fff;">
                ...
                <div style="display:flex; flex-direction:column; gap:10px;">
                    <?php
                    $perks = [
                        ['bi-check-circle-fill','No booking fees, ever'],
                        ['bi-check-circle-fill','Free cancellation on most bookings'],
                        ['bi-check-circle-fill','Exclusive member-only deals'],
                    ];
        ...
        <div style="width:100%; max-width:440px;">
            ...
            <div class="card-form">
                ...
                <form method="POST" novalidate>
                    ...
                    <div class="row g-3 mb-0">
                        ...
                        <div class="col-6">
                            ...
                            <input type="text" name="lname" class="form-control" placeholder="Dela Cruz"
                    ...
                    <div class="mt-3">
                        ...
                        <input type="email" name="email" class="form-control" placeholder="you@email.com"
                               ...
                               title="Email must end in .com (e.g. you@example.com)"
                    ...
                    <button type="submit" name="register" class="btn-rd w-100"
                ...
                <p class="text-center" style="font-size:14px; margin:0; color:#666;">
                    ...
                    <a href="/auth/login.php" style="color:var(--rd-red); font-weight:600;">Sign in</a>
                </p>
